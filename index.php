...
<body style="background: url(photo/admin.jpg) fixed;">
...
<div class="dashboard treb " style="background-color: rgba(0, 0, 0, 0.4);  opacity: inherit;">
	...
	<ul>
		...
		<a href="savedCv.php"><li><i class="fa fa-user-circle fa-fw"></i>Saved Resume</li></a>
...
<div style=";margin-left: 18%;padding-top: 122px" class="flex">
	<div class=" well" style="width: 52%; background-color: rgba(0, 0, 0, 0.4);  opacity: inherit;" id="mydiv">
		<img src="photo/welcome.jpg" class="img-responsive img-thumbnail" style="width:550px ;height: 224px;" >
		<div class="admin-pic"><img src="photo/user.png" class="img-circle img-thumbnail"></div>
		<div class="admin-name img-thumbnail treb ">Sakshi Chavan</div>
		<div class="well well-sm treb" style="position: relative;top: -122px;">
			<h4>Message From Admin</h4><img src="photo/admin.jpeg" class="pull-right img-thumbnail " style="width: 133px;margin: 4px;height: 155px">
    ...
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body">
      	...
      	<div class="panel panel-primary">
      		...
      		<div class="panel-body">Select your sutiable cv theme which you want to build,customise it and get your resume faster and professional </div>
      		<div class="panel-body">Select your sutiable cv theme which you want to build,customise it and get your resume faster and professional</div>
      		<div class="panel-body">Select your sutiable cv theme which you want to build,customise it and get your resume faster and professional </div>
      	</div>
    ...
    <div id="collapse3" class="panel-collapse collapse">
      <div class="panel-body">
      	...
      	<div class="panel panel-primary">
      		...
      		<div class="panel-body">Select your sutiable suitable theme </div>
      		<div class="panel-body">Select your sutiable resume theme </div>
      		<div class="panel-body">Select your sutiable resume</div>
      	</div>
